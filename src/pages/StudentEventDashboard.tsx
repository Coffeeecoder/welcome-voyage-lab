      ...
      <main className="pt-20 sm:pt-24 pb-12 sm:pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Event Header */}
            <div className="glass-card rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-primary opacity-10 rounded-full blur-3xl"></div>
              <div className="relative">
                <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 items-start lg:items-center justify-between mb-4 sm:mb-6">
                  <div className="flex-1">
                    <Badge className="mb-2 sm:mb-3 bg-success/20 text-success-foreground text-xs sm:text-sm">
                      {eventData.status === "active" ? "🔴 Live Event" : "Upcoming"}
                    </Badge>
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-3 gradient-text">
                      {eventData.name}
                    </h1>
                    <p className="text-muted-foreground mb-3 sm:mb-4 text-sm sm:text-base">{eventData.description}</p>
