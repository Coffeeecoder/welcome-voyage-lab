  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 h-[calc(100vh-150px)] sm:h-[calc(100vh-200px)]">
        {/* Chat List Sidebar */}
        <Card className="lg:col-span-1 p-3 sm:p-4 flex flex-col">
          <div className="mb-4">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-4">
            <TabsList className="grid w-full grid-cols-4 h-auto">
              ...
              <TabsTrigger value="event" className="text-xs sm:text-sm px-2 sm:px-3">Events</TabsTrigger>
              <TabsTrigger value="mentorship" className="text-xs sm:text-sm px-2 sm:px-3">Mentor</TabsTrigger>
