...
export const JudgeSidebar = ({ activeView, onViewChange }: JudgeSidebarProps) => {
  return (
    <aside className="h-screen w-64 bg-gradient-subtle border-r border-border shadow-lg">
      <div className="p-4 sm:p-6">
        <h2 className="text-lg sm:text-xl font-bold gradient-text mb-6 sm:mb-8">Judge Panel</h2>
